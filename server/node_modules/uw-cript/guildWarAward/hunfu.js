...
var guildArr1 =  require("./hunfu/guildArr1.json");
var guildArr2 =  require("./hunfu/guildArr2.json");
var guildArr3 =  require("./hunfu/guildArr3.json");
var guildArr4 =  require("./hunfu/guildArr4.json");
var guildArr5 =  require("./hunfu/guildArr5.json");
var guildArr6 =  require("./hunfu/guildArr6.json");
var guildArr7 =  require("./hunfu/guildArr7.json");
var guildArr8 =  require("./hunfu/guildArr8.json");
...
var guildArr = [];
guildArr = guildArr.concat(guildArr1);
guildArr = guildArr.concat(guildArr2);
guildArr = guildArr.concat(guildArr3);
guildArr = guildArr.concat(guildArr4);
guildArr = guildArr.concat(guildArr5);
guildArr = guildArr.concat(guildArr6);
guildArr = guildArr.concat(guildArr7);
guildArr = guildArr.concat(guildArr8);
