    ...
    guildWarRecordDao.selectCols(sClient,"id,lastRankData"," 1=1 order by recordTime desc",[],function(err,data){
        ...
        for(var i = 1;i<=5;i++){
            ...
            for(var j = 0;j<locUserArr.length;j++){
                ...
                var loUItems = getAwardItems(locGroupId,locU.rank,3);
                var locMail = mailBiz.createEntityByType(locU.userId, c_prop.mailTypeKey.guildWarRank3, [c_prop.guildGroup[locGroupId], locU.rank], loUItems);
                tempList.push(locMail);
            }
        }
